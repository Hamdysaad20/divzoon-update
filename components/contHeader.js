...
<h1  className="logoheader">Divzoon</h1>
          ...
          <main className="xl:ml-9 mt-10 mx-auto max-w-screen-xl		 px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-36 lg:px-8 xl:mt-28">
            <div className="text-center sm:text-center lg:text-left">
              <h1 className="text-5xl tracking-tight font-extrabold text-gray-900 sm:text-6xl md:text-8xl">
                <span className=" block xl:inline">Contact Us</span><br/>
              </h1>
              <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-2xl lg:mx-0">
              Send us your queries and we will get back to you within 24 hours with all the help you need.              </p>
