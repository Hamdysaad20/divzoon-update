...
<h1 className="md:mt-14 pt-24 mt-10  text-2xl tracking-tight font-extrabold text-gray-900 sm:text-3xl  text-center "> 
    Our Main Services
</h1>
...
<div class="relative  px-4 mt-6">
  ...
  <img src="https://i.ibb.co/54fCRWh/removal-ai-tmp-61508bdca6870.png"  className= " w-[300px] p-3 mb-10 unselectable w-96 mb-3 object-cover display-block object-center mx-auto "/>    
...
<button className=" mt-3 text-red-500 text-center h-12  md:w-32 w-full  font-medium ">
...
<div class="relative px-4 mt-6  h-full">
  ...
  <img src="https://d1i2cp4a5c819e.cloudfront.net/wp-content/uploads/2020/02/services-mobile-apps.svg"  className=" w-[250px]  mb-12   object-cover object-center mx-auto  "/>    
   ...
   <h4 class="mt-1  text-2xl tracking-tight font-bold text-gray-800 sm:text-3xl text-center" >Mobile Apps </h4>

 
 <div class="mt-4 text-center mb-9">
   <span class="t-5 mr-4  text-base text-gray-500  sm:text-lg    md:text-xl">we build intuitive and engaging Android,iOS and cross-platform apps for businesses, consumers and enterprises that end users love and adapt to them very quickly.</span>
 </div>  
...
<div class="relative  px-4 mt-6  ">
  ...
  <img  src="https://d1i2cp4a5c819e.cloudfront.net/wp-content/uploads/2020/02/services-ui-ux.svg"  className=" w-[300px] mb-12 object-cover mx-auto object-center   "/>    
   ...
   <h4 class="mt-1  text-2xl tracking-tight font-bold text-gray-800 sm:text-3xl text-center">Ui/Ux Design</h4>
...
<div class="relative px-4 mt-6 grid-cols-2  ">
  <div style={{backgroundColor: '#C9E8DB'}} class="bg-white divcard p-6 rounded-lg duration-500 hover:shadow-2xl my-7 pt-2">
   ...
   <div>
   <h4 class="mt-1  text-2xl tracking-tight font-bold text-gray-800 sm:text-3xl text-center">Web Development</h4>

<div class="mt-4 text-center mb-9">
  <span class="t-5 mr-4  text-base text-gray-500  sm:text-lg    md:text-xl">Our web developers create custom web application solutions we deliver web presence to help you grow your business using the best web technologies</span>
</div> 
