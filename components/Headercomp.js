  ...
  return (
    <header className="">
      <div className="relative bg-white overflow-hidden  ">
            ...
            <main className="xl:ml-9 mt-10 mx-auto max-w-screen-xl		 px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="text-center sm:text-center lg:text-left">
                ...
                <p className=" mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  ...
                  businesses.Hire the best programmers at affordable prices.
                </p>
        ...
        <div className="lg:absolute relative  lg:inset-y-0 lg:right-0 lg:w-1/2">
          <img
            src="/HeaderSecImg.jpg"
            alt="me"
            height="30"
            width="30"
            layout="responsive"
            className="h-80   sm:h-72 md:h-96 lg:w-full lg:h-full"
            priority
            eager
          />
        </div>
