          ...
          <div className="flex flex-col items-center md:flex-row">
            ...
            <div className="w-full mt-16 md:mt-0 md:w-2/5">
              <div className="relative z-10 h-auto p-8 py-10 overflow-hidden bg-white border-b-2 border-gray-300 rounded-lg shadow-2xl px-7">
                ...
                <div className="block">
                  <button className="w-full px-3 py-4 font-medium text-white bg-red-700 rounded-lg">Log Me In</button>
                </div>
                <p className="w-full mt-4 text-sm text-center text-gray-500">Say hi! and we will contact with you. <a href="#_" className="text-blue-500 underline"> Pricing? </a></p>
              </div>
            </div>
          </div>
        </div>
