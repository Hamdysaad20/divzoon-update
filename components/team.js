          ...
          <div className="grid w-full grid-cols-2 gap-10 sm:grid-cols-3 lg:grid-cols-4">
            <div className="flex flex-col items-center justify-center col-span-1">
              <div className="hover:scale-105 duration-300  relative p-5">
                ...
                <img className="relative z-20 w-full rounded-full" src="https://i.ibb.co/zbDZXTG/2.jpg" />
              </div>
            ...
            <div className="flex flex-col items-center justify-center col-span-1">
              <div className="hover:scale-105 duration-300  relative p-5">
                ...
                <img className="relative z-20 w-full rounded-full" src="https://i.ibb.co/4VvFw8K/1.jpg" />
              </div>
              <div className="mt-3 space-y-2 text-center">
                <div className="space-y-1 text-lg font-medium leading-6">
            ...
            <div className="flex flex-col items-center justify-center col-span-1">
              <div className="hover:scale-105 duration-300  relative p-5">
                ...
                <img className="relative z-20 w-full rounded-full" src="https://i.ibb.co/pzgcyRr/3.jpg" />
              </div>
              <div className="mt-3 space-y-2 text-center">
                <div className="space-y-1 text-lg font-medium leading-6">
                  <h3>Esraa Afifi</h3>
            ...
            <div className="flex flex-col items-center justify-center col-span-1">
              <div className="hover:scale-105 duration-300  relative p-5">
                <div className="absolute z-10 w-full h-full -mt-5 -ml-5 rounded-full rounded-tr-none bg-green-100" />
                <img className="relative z-20 w-full rounded-full" src="https://i.ibb.co/6wxY4v9/4.jpg" />
              </div>
              <div className="mt-3 space-y-2 text-center">
                <div className="space-y-1 text-lg font-medium leading-6">
                  <h3>Tony Misbah</h3>
            ...
            <div className="flex flex-col items-center justify-center col-span-1">
              <div className="hover:scale-105 duration-300  relative p-5">
                ...
                <img className="relative z-20 w-full rounded-full" src="https://i.ibb.co/7tQby6n/5.jpg" />
              </div>
              <div className="mt-3 space-y-2 text-center">
                <div className="space-y-1 text-lg font-medium leading-6">
                  <h3> Dina Alamoury</h3>
            ...
            <div className="flex flex-col items-center justify-center col-span-1">
              <div className="hover:scale-105 duration-300  relative p-5">
                <div className="absolute z-10 w-full h-full -mt-5 -ml-5 rounded-full rounded-tr-none bg-green-100" />
                <img className="relative z-20 w-full rounded-full" src="https://i.ibb.co/GHrMt77/6.jpg" />
              </div>
              <div className="mt-3 space-y-2 text-center">
                <div className="space-y-1 text-lg font-medium leading-6">
                  <h3>Hatem Ali</h3>
            ...
            <div className=" flex flex-col items-center justify-center col-span-1">
              <div className=" hover:scale-105 duration-300 relative p-5">
                <div className=" absolute z-10 w-full h-full -mt-5 -ml-5 rounded-full rounded-tr-none bg-green-100" />
                <img className="relative z-20 w-full rounded-full" src="https://i.ibb.co/jGrPcCz/7.jpg" />
              </div>
              <div className="mt-3 space-y-2 text-center">
                <div className="space-y-1 text-lg font-medium leading-6">
            ...
            <div className="flex flex-col items-center justify-center col-span-1">
              <div className=" relative p-5">
                ...
                <img className="animate-ping p-6 sm:12 md:p-11 relative z-20 w-full rounded-full" src="https://i.ibb.co/2FzRWpC/plus-1.png" />
